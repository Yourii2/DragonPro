...
const SetupWizard: React.FC<SetupWizardProps> = ({ onComplete }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    adminPass: '',
    // New setup options
    productSource: 'both', // 'factory' | 'suppliers' | 'both'
    purchasePriceType: 'full_cost', // 'full_cost' | 'vendor_price'
      ...
      <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl shadow-blue-500/10 overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-8 md:p-12 relative overflow-y-auto max-h-screen md:max-h-[700px]">
          ...
          {step === 4 && (
            <div className="animate-in fade-in slide-in-from-left-4 duration-500">
              <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                <Settings className="text-blue-600" /> إعدادات المنتجات
              </h2>
          ...
          {step === 5 && (
            <div className="animate-in fade-in slide-in-from-left-4 duration-500">
              <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                <Tag className="text-blue-600" /> إعدادات البيع
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl">
                <div className="space-y-1">

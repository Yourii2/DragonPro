    ...
    (async () => {
      try {
        ...
        if (result.success) {
          ...
          setReceivingData({ supplierId: '', warehouseId: '', items: [{ id: Date.now(), itemType: defaultReceivingItemType, isNew: true, name: '', color: '', size: '', costPrice: 0, newCostPrice: 0, vendorPrice: 0, sellingPrice: 0, qty: 1, barcode: '', productId: '', _parentId: '', _color: '', _size: '' }], paidAmount: 0, treasuryId: '' });
    ...
    (async () => {
      try {
        ...
        if (result.success) {
          ...
          setReturnsData({ supplierId: '', warehouseId: '', items: [{ id: Date.now(), productId: '', qty: 1, costPrice: 0, vendorPrice: 0, name: '', returnType: '', _parentId: '', _color: '', _size: '' }], receivedAmount: 0, treasuryId: '' });
    ...
    (async () => {
      try {
        ...
        if (result.success) {
          ...
          setTransferData({ from: '', to: '', items: [{ transferType: '', productId: '', _parentId: '', _color: '', _size: '', qty: 1 }] });
